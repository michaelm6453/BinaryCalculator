...
public class BinaryTest
{
    ...
    public void or1() {
        ...
        Binary binary2 = new Binary("010101");
        Binary binary3 = Binary.or(binary1, binary2);
    ...
    // Test for bitwise logical OR (all bits are ones)
    @Test
    public void or3() {
    ...
    // Test for bitwise logical AND (edge case: both inputs are zero)
    @Test
    public void and() {
        Binary binary1 = new Binary("0");
        Binary binary2 = new Binary("0");
    ...
    public void multiply1() {
        ...
        Binary binary2 = new Binary("11");
        Binary binary3 = Binary.multiply(binary1, binary2);
        assertTrue(binary3.getValue().equals("1111")); // 5 * 3 = 15 (binary 1111)
    }
